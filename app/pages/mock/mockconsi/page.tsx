                ...
                {scholarships.map((scholarship, index) => {
                  ...
                  return (
                    <tr key={scholarship.id}>
                      ...
                      <td className="px-2 py-2 border w-40 text-center"><button className="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-blue-400">ผ่าน</button></td>
                      <td className="px-2 py-2 border w-28 text-center"><button className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-400">comment</button></td>
                    </tr>
                  );
                })}
              </tbody>
