...
//   prevStep: () => void;
// }> = ({ questions, addQuestion, deleteQuestion, updateQuestion, handleSubmit, prevStep }) => {
...
//   return (
//     <div className="items-top flex min-h-screen justify-center bg-white">
...
//                     onChange={(date) => updateQuestion(q.id, 'selectedDate', date)}
...
//     rewards: [] as (
//       | 'ลดค่าบำรุงมหาวิทยาลัย'
//       | 'ลดค่าหน่วยกิต'
//       | 'ลดค่าธรรมเนียมพิเศษคณะ'
//       | 'อื่นๆ'
//     )[],
//     otherReward: '',
//   });
...
//     const newRewards = projectData.rewards.includes(
//       reward as 'ลดค่าบำรุงมหาวิทยาลัย' | 'ลดค่าหน่วยกิต' | 'ลดค่าธรรมเนียมพิเศษคณะ' | 'อื่นๆ'
//     )
