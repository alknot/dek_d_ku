...
export default function PrintEx() {
  ...
  const competitiveMapping: { [key: string]: string } = {
    UNIVERSITY_COMPETITION: 'แข่งขันระดับอุดมศึกษา',
    NATIONAL_COMPETITION: 'แข่งขันระดับชาติ',
    INTERNATIONAL_COMPETITION: 'แข่งขันระดับนานาติ',
    POSITION: 'การดำรงตำแหน่งงง',
    SOCIAL: 'สร้างประโยชน์ต่อสังคม',
  };
      ...
      <Page size="A4" orientation="landscape" style={styles.page}>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRow}>
            ...
            <Text style={[styles.tableColHeader, { width: '25%' }]}>รายการย่อย</Text>
          </View>
          ...
          {studentList.map((student, index) => (
            <View style={styles.tableRow} key={student.id}>
              ...
              <Text style={[styles.tableCol, { width: '25%' }]}>
                {student.extracurricular?.extracurricularType
                  ? competitiveMapping[student.extracurricular.extracurricularType] ||
                    student.extracurricular.extracurricularType
                  : ''}
              </Text>
            </View>
